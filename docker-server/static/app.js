...
const certHintEl = document.getElementById("cert-hint");
if (window.pywebview) certHintEl.hidden = true;
...
//
// This copy is the one the desktop loads when it opens a remote server, which is
// exactly the situation where the address needs changing -- and where the race
// was being lost.
